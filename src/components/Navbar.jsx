...
export default function Navbar({ active, onReport, showReport }) {
        ...
        <div className="max-w-content mx-auto px-4 h-12 flex items-center justify-between">
          ...
          <div className="flex md:hidden items-center gap-2">
            <button onClick={() => setOpen(o => !o)}
              className="w-9 h-9 flex flex-col items-center justify-center gap-1.5 text-[#6a6a6a] hover:text-white transition-colors"
